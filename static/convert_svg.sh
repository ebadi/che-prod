...
convert -density 200 logo-with-circle.svg -resize 180x180 -transparent white logo-with-circle180x180.png
convert -density 200 logo-with-circle.svg -resize 57x57 -transparent white apple-touch-icon-57x57.png
...
convert -density 288  logo-with-circle.svg -gravity center -resize 1024x1024 icon-only.png
convert -density 288  logo-with-circle.svg -gravity center -resize 1024x1024 icon-foreground.png
convert -density 288  logo-with-circle.svg -gravity center -resize 1024x1024 icon-background.png
convert -density 288  logo-with-circle.svg -gravity center -resize 500x500   splash.png
convert -density 288  logo-with-circle.svg -gravity center -resize 500x500   splash-dark.png
